    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <header className="px-6 lg:px-12 h-20 flex items-center bg-white/80 backdrop-blur-md border-b sticky top-0 z-50">
        <Link className="flex items-center justify-center" href="/">
          <Image 
            src="https://firebasestorage.googleapis.com/v0/b/studio-3673070449-f277c.firebasestorage.app/o/brand%2Fcleansweep-logo.jpg?alt=media"
            alt="CleanSweep Logo"
            width={220}
            height={60}
            priority
        ...
        <div className="container px-6 mx-auto">
          ...
          <div className="pt-10 border-t flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-[0.2em] flex items-center gap-1">
              <span className="text-lg">©</span> 2026 CleanSweep Cleaning Company LLC. All Rights Reserved.
            </p>
